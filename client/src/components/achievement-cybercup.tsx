        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
          <div>
            <h3 className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-4 sm:mb-6">
              Secured <span className="text-primary">2nd Runner-Up (3rd position)</span> among 450 teams at Cyber Cup 5.0, Amity University
            </h3>
          </div>
          <div className="modern-card rounded-3xl p-3 border w-full max-w-md sm:max-w-lg mx-auto">
            <img src="/achievements/cybercup.jpeg" alt="Cyber Cup 5.0 Achievement" className="rounded-2xl w-full h-72 sm:h-80 md:h-96 object-cover" />
          </div>
        </div>
      </div>
    </section>
